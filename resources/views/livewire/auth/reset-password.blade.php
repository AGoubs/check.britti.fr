            ...
            <div class="card-body">
              <form wire:submit.prevent="resetPassword" action="#" method="POST" role="form text-left">
                <div>
                  ...
                  <div class="mb-3">
                    <input wire:model="email" id="email" type="email"
                      class="form-control @error('password')is-invalid @enderror" placeholder="Email" aria-label="Email"
                ...
                <div>
                  ...
                  <div class="mb-3">
                    <input wire:model="passwordConfirmation" id="password" type="password"
                      class="form-control @error('password')is-invalid @enderror" placeholder="Confirmation du mot de passe"
                      aria-label="Password" aria-describedby="password-addon">
                  </div>
                ...
                <div class="text-center">
                  <button type="submit"
                    class="btn bg-gradient-info w-100 mt-4 mb-0">{{ __('Réinitialiser mon mot de passe') }}</button>
                </div>
              </form>
              ...
              @if ($showFailureNotification)
                <div wire:model="showFailureNotification" class="mt-3 alert alert-light alert-dismissible fade show"
                  role="alert">
