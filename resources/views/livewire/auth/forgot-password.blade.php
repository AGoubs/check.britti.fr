                        ...
                        <div class="card-body">
                            <form wire:submit.prevent="recoverPassword" action="#" method="POST" role="form text-left">
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="btn bg-gradient-info w-100 mt-4 mb-0">{{ __('Envoyez un mail') }}</button>
                                </div>
                            </form>
                            @if ($showSuccesNotification)
                                <div wire:model="showSuccesNotification"
                                    ...
                                    <span
                                        class="alert-text text-white">{{ __(' Un email pour réinitiliser votre mot de passe vous a été envoyé !') }}</span>
